...
import { DriverHome } from '@/components/driver-portal/DriverHome';
...
export default function DashboardPage() {
  ...
  // Drivers get their own home screen, which loads its own data.
  if (userRole === 'DRIVER') {
    return <DriverHome />;
  }
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="card">
          ...
          {compliance.expired > 0 ? (
            <p className="compliance-alert mt-4 rounded-lg border border-red-500/30 bg-red-500/10 px-3 py-2 text-xs font-medium">
